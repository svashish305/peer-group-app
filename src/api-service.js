export class API {
	...
	static updateOrCreateUser(body, token) {
		return fetch(
			`${process.env.REACT_APP_API_URL}/api/update_or_create_user/`,
			{
				method: 'POST',
				headers: {
					'Content-Type': 'application/json',
	...
	static getGroupOfUser(user_id, token) {
		return fetch(
			`${process.env.REACT_APP_API_URL}/api/users/${user_id}/group/`,
			{
				method: 'GET',
				headers: {
					'Content-Type': 'application/json',
	...
	static getFeedbacksOfUser(user_id, token) {
		return fetch(
			`${process.env.REACT_APP_API_URL}/api/users/${user_id}/feedbacks/`,
			{
				method: 'GET',
				headers: {
					'Content-Type': 'application/json',
	...
	static getMeetingsOfUser(user_id, token) {
		return fetch(
			`${process.env.REACT_APP_API_URL}/api/users/${user_id}/meetings/`,
			{
				method: 'GET',
				headers: {
					'Content-Type': 'application/json',
	...
	static saveUserAvailability(user_id, body, token) {
		return fetch(
			`${process.env.REACT_APP_API_URL}/api/users/${user_id}/set_availability/`,
			{
				method: 'POST',
				headers: {
					'Content-Type': 'application/json',
	...
	static getUsersInGroup(group_id, token) {
		return fetch(
			`${process.env.REACT_APP_API_URL}/api/groups/${group_id}/users/`,
			{
				method: 'GET',
				headers: {
					'Content-Type': 'application/json',
	...
	static getMeetingsOfGroup(group_id, token) {
		return fetch(
			`${process.env.REACT_APP_API_URL}/api/groups/${group_id}/meetings/`,
			{
				method: 'GET',
				headers: {
					'Content-Type': 'application/json',
	...
	static scheduleMeetingForGroup(group_id, body, token) {
		return fetch(
			`${process.env.REACT_APP_API_URL}/api/groups/${group_id}/set_meeting/`,
			{
				method: 'POST',
				headers: {
					'Content-Type': 'application/json',
